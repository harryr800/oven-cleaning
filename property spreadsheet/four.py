...
def create_brrrr_excel(data):
    ...
    def write_table(start_row, start_col, section_name, fields):
        ...
        for i, field in enumerate(fields, start=1):
            ...
            sheet.cell(row=start_row + i, column=start_col + 1, value="").border = border
    ...
    write_table(1, 1, "INPUT FIELDS", input_fields)

    # Write Data Sections
    write_table(20, 1, "OPERATING EXPENSES", list(data['Operating Expenses'].keys()))
    write_table(20, 5, "RENTAL INCOME SOURCES", list(data['Rent Income'].keys()))
    ...
    print("BRRRR Property Calculator has been created with Input Fields!")
