...
def calculate_brrrr_metrics(data):
    ...
    return {
        ...
        'ROI': roi,
        'Equity After 5 Years': refinance_amount - (5 * 12 * monthly_payment)
    }
...
if __name__ == "__main__":
    ...
    data = {
        ...
        'Refinance LTV': 80,
        'Rent Income': {"Rent 1": 3200, "Rent 2": 1950, "Rent 3": 1950},
        'Operating Expenses': {"Hydro": 50, "Water": 50, "Gas": 100, "Vacancy": 388, "Management": 775}
    }
